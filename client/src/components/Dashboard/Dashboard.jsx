      ...
      <div className="flex-1 p-4">
        ...
        <div className="flex items-center mb-4">
          <div className="relative">
            <img src={imgUrl || profilePic} alt="Profile" className="w-24 h-24 rounded-full mr-4" />
            {/* Button */}
            <label htmlFor="imageInput" className="absolute bottom-0 right-0 bg-blue-600 text-white font-bold px-2 py-1 rounded-full flex items-center justify-center hover:bg-blue-700 cursor-pointer">
              <input type="file" id="imageInput" className="hidden" onChange={(e) => { setSelectedFile(e.target.files[0]); uploadImage(); }} />
              <FaPencilAlt />{loading1 ? "Loading..." : ""}
            </label>
          </div>
          <div>
